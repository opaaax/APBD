...
public class EmpDeptSalgradeTests
{
    ...
    public void ShouldReturnEmployeesFromChicago()
    {
        ...
        List<Emp> result = emps.Where(e => depts.Where(d => d.Loc == "CHICAGO").Select(d => d.DeptNo).ToList().Contains(e.DeptNo)).ToList(); 
    ...
    public void ShouldReturnEmployeesWithCommission()
    {
        ...
        var result = emps.SelectMany(e => e.EName, (e, e2) => new
        {
            e.EName,
            e.Comm,
        }).Where(e => e.Comm != null); 
    ...
    public void ShouldReturnEmployeesEarningMoreThanDeptAverage()
    {
        ...
        var result = emps.Where(e => e.Sal > emps.Where(e2 => e2.DeptNo == e.DeptNo).Average(s => s.Sal)).Select(e => e.EName); 
